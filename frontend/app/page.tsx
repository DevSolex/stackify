    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-white">
      ...
      <section className="flex flex-col items-center justify-center py-32 px-6 text-center">
        <div className="max-w-4xl space-y-8">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-cyan-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            ...
            <Link href="/create">
              <Button variant="outline" size="lg" className="text-lg px-8 py-6 rounded-full border-zinc-700 hover:bg-zinc-800">
                Post a Task
              </Button>
            </Link>
          </div>
      ...
      <section className="py-24 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-2xl bg-zinc-800/50 border border-zinc-700 hover:border-violet-500/50 transition-colors">
            ...
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-2xl bg-zinc-800/50 border border-zinc-700 hover:border-cyan-500/50 transition-colors">
            ...
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-2xl bg-zinc-800/50 border border-zinc-700 hover:border-purple-500/50 transition-colors">
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 bg-zinc-800 -z-10 transform scale-x-75"></div>

            <div className="flex flex-col items-center text-center space-y-6">
              <div className="h-24 w-24 rounded-full bg-zinc-900 border-4 border-violet-600 flex items-center justify-center text-3xl font-bold z-10">
                1
              </div>
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              <div className="h-24 w-24 rounded-full bg-zinc-900 border-4 border-cyan-600 flex items-center justify-center text-3xl font-bold z-10">
                2
              </div>
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              <div className="h-24 w-24 rounded-full bg-zinc-900 border-4 border-purple-600 flex items-center justify-center text-3xl font-bold z-10">
                3
              </div>
